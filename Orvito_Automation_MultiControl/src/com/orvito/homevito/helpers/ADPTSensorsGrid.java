...
public class ADPTSensorsGrid extends BaseAdapter implements OnClickListener {
	...
	public ADPTSensorsGrid(Activity activity,Handler handler,MODELRoom selectedRoom,int gridcolor) {
		_activity=activity;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		String imageToPick = currentNode.getHardwareType().getName()+ currentNode.getNodeStatus().getState();//receivedState;
