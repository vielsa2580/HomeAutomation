...
public class CopyOfACTHomepage_MPEG extends Activity implements OnClickListener,SurfaceHolder.Callback,OnCompletionListener,OnErrorListener{	
	...
	protected void onStart() {
		super.onStart();
		new OMTabSync().syncTablet(CopyOfACTHomepage_MPEG.this,new Handler());//sending a tab sync request so that we have updated state of pir sensor

		_pauseButton.setVisibility(View.GONE);
		registerReceiver(timeTickReceiver, new IntentFilter(Intent.ACTION_TIME_TICK));
		updateDateTime();
		new OMWeather().tcpGetCurrentWeather(CopyOfACTHomepage_MPEG.this,new Handler());
		updateDateTime();
	...
	private void setContentView() {
		...
		if(apiLevel>13) _UIVVVideoStream.setZOrderOnTop(true);
	...
	public void devicecontrol(View v){
		startActivity(new Intent(CopyOfACTHomepage_MPEG.this,ACTDeviceMaster.class));
	}

	public void userdirectory(View v){
		startActivity(new Intent(CopyOfACTHomepage_MPEG.this,ACTUserDirectory.class));
	}

	public void openabout(View v){
		startActivity(new Intent(CopyOfACTHomepage_MPEG.this,ACTAbout.class));
	}

	public void opendevsummary(View v){
		startActivity(new Intent(CopyOfACTHomepage_MPEG.this,ACTSensorControl.class));
	}
	...
	private void updateDateTime() {
		...
		CopyOfACTHomepage_MPEG.this.timehour.setText(hourString+":");
		CopyOfACTHomepage_MPEG.this.timeminute.setText(minuteString);
		CopyOfACTHomepage_MPEG.this.timesecond.setText(secondString);
		CopyOfACTHomepage_MPEG.this.ampm.setText(ampm);
		CopyOfACTHomepage_MPEG.this.date.setText(date);
		...
		protected void onPostExecute(Boolean result) {
			try{
				if(result){
					...
					_pauseButton.setVisibility(View.INVISIBLE);
					videoUnavailableLayout.setVisibility(View.INVISIBLE);
					_mMediaPlayer.setOnCompletionListener(CopyOfACTHomepage_MPEG.this);
					_mMediaPlayer.start();
					_playing=true;
					...
					_pauseButton.setVisibility(View.INVISIBLE);
					CopyOfACTHomepage_MPEG._playing=false;
	...
	public void onCompletion(MediaPlayer mp) {
		...
		releaseMediaPlayer();
		startOrSwitchStream(3000);
	}

	@Override
	public boolean onError(MediaPlayer mp, int what, int extra) {
		Log.e("MP_Error occured", "what:"+what+"  extra:"+extra);
		return false;
	}
	...
	public class IncomingCallReceiver extends BroadcastReceiver {
		...
		public void onReceive(final Context context, final Intent intent) {
			...
			try{
				...
				SipAudioCall incomingCall =CopyOfACTHomepage_MPEG.this.manager.takeAudioCall(intent, sipAudioCallListener);
				...
				builder.setPositiveButton("ACCEPT", new DialogInterface.OnClickListener() {
					...
					public void onClick(DialogInterface dialog, int which) {				
						try{								 
							...
							startActivity(new Intent(CopyOfACTHomepage_MPEG.this,ACTOnSIPCall.class));
						} catch (Exception e) {
