...
public class CopyOfACTHomepage extends Activity implements OnClickListener,SurfaceHolder.Callback,OnCompletionListener{	
	...
	protected void onStart() {
		super.onStart();
		new OMTabSync().syncTablet(CopyOfACTHomepage.this,new Handler());//sending a tab sync request so that we have updated state of pir sensor

		_pauseButton.setVisibility(View.GONE);
		registerReceiver(timeTickReceiver, new IntentFilter(Intent.ACTION_TIME_TICK));
		updateDateTime();
		new OMWeather().tcpGetCurrentWeather(CopyOfACTHomepage.this,new Handler());
		updateDateTime();
	}
...
//		}
	...
	public void devicecontrol(View v){
		startActivity(new Intent(CopyOfACTHomepage.this,ACTDeviceMaster.class));
	}

	public void userdirectory(View v){
		startActivity(new Intent(CopyOfACTHomepage.this,ACTUserDirectory.class));
	}
	...
	private void updateDateTime() {
		...
		CopyOfACTHomepage.this.timehour.setText(hourString+":");
		CopyOfACTHomepage.this.timeminute.setText(minuteString);
		CopyOfACTHomepage.this.timesecond.setText(secondString);
		CopyOfACTHomepage.this.ampm.setText(ampm);
		CopyOfACTHomepage.this.date.setText(date);
					...
					try {
						...
						_mMediaPlayer.setOnPreparedListener(new OnPreparedListener() {					
							...
							public void onPrepared(MediaPlayer mp) {
								CopyOfACTHomepage.this.runOnUiThread(new Runnable() {
									...
									public void run() {
										try{
											...
											if(_mMediaPlayer!=null){
												_mMediaPlayer.setOnCompletionListener(CopyOfACTHomepage.this);
											}
						...
						CopyOfACTHomepage.this.runOnUiThread(new Runnable() {
							public void run() {
								...
								CopyOfACTHomepage._playing=false;
	...
	public class IncomingCallReceiver extends BroadcastReceiver {
		...
		public void onReceive(final Context context, final Intent intent) {
			...
			try{
				...
				SipAudioCall incomingCall =CopyOfACTHomepage.this.manager.takeAudioCall(intent, sipAudioCallListener);
				...
				builder.setPositiveButton("ACCEPT", new DialogInterface.OnClickListener() {
					...
					public void onClick(DialogInterface dialog, int which) {				
						try{								 
							...
							startActivity(new Intent(CopyOfACTHomepage.this,ACTOnSIPCall.class));
						} catch (Exception e) {
